...
#define STRING_CONFIG_H_AUTHOR "(Thordarsen, default config)" // Who made the changes.
...
//#define SWITCHING_EXTRUDER
  ...
  #define SWITCHING_EXTRUDER_SERVO_ANGLES { 30, 0 } // Angles for E0, E1[, E2, E3]
  #if EXTRUDERS > 3
...
//#define HOTEND_OFFSET_X { 0.0, 37.50 } // (mm) relative X-offset for each nozzle
//#define HOTEND_OFFSET_Y { 0.0, 1.15 }  // (mm) relative Y-offset for each nozzle
//#define HOTEND_OFFSET_Z { 0.0, -1.68 }  // (mm) relative Z-offset for each nozzle
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 139, 405}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 15, 35, 35 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 5000,5000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 22, -1, 0 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 18), (Y_MAX_POS - 10), 20 }
